...
## $B_{sig}$ decay chain: with more than 1 neutrino
```{=latex}
\begin{figure}
\begin{tikzpicture} \begin{feynman}
    \vertex (a1) {\(\overline b\)};
    \vertex[right=3cm of a1] (a2);
    \vertex[right=3cm of a2] (a4) {\(\overline c\)};
    \vertex[below=2em of a1] (b1) {\(d\)};
    \vertex[below=2em of a4] (b2) {\(d\)};
    \vertex at ($(a2)!0.5!(a2)!0.5cm!90:(a2)$) (d);
    \vertex[above=of a4] (c1) {\(\tau^+\)};
    \vertex[above=2em of c1] (c3) {\(\nu_\tau\)};
    \vertex at ($(c1)!0.5!(c3) - (1cm, 0)$) (c2);

    \diagram* {
        (a4) -- [fermion] (a2) -- [fermion] (a1),
        (b1) -- [fermion] (b2),
        (c3) -- [anti fermion, out=180, in=45] (c2) -- [anti fermion, out=-45, in=180] (c1),
...
\caption{
    ...
    $B \rightarrow (D \rightarrow \text{various modes}) (\tau \rightarrow \mu \nu_\mu) \nu_\tau$
}
\end{figure}
```

## $B_{sig}$ decay chain: 1 neutrino
